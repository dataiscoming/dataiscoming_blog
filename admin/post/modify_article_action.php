<?php 
    ...
    $_POST['id_modif'] != NULL AND $_POST['status_post'] != NULL){
		...
		$req = $con->prepare("UPDATE posts SET title=:title_modif, corpus=:corpus_modif, timestamp_modif=:time, status_post=:status
		WHERE ID=:id_modif");
